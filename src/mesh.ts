...
import {TriangleMesh, MeshInitializer} from "./map-gen-4/dual-mesh/index";
import {choosePoints} from "./map-gen-4/generate-points";
import type {Mesh} from "./map-gen-4/types.d";

export async function makeMesh() {
    let pointsData = choosePoints(param.mesh.seed, param.spacing, param.mountainSpacing);
